 ...
 *
 */
class FurnitureFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'price' => ['type' => 'decimal', 'length' => 14, 'precision' => 4, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
    ...
    public $records = [
        [
            ...
            'discount' => 1,
            'status' => 1,
            'created' => '2016-09-08 08:10:22',
            'modified' => '2016-09-08 08:10:22'
        ],
    ];
}
