...
<section class="content-header">
    <h1>
        <CakePHPBakeOpenTag= __('Edit <?= $singularHumanName ?>') CakePHPBakeCloseTag>
    </h1>
    <ol class="breadcrumb">
...
<section class="content">
    <div class="box box-success">
        <div class="box-header with-border">
            <h3 class="box-title"><CakePHPBakeOpenTag= __('Edit <?= $singularHumanName ?>') CakePHPBakeCloseTag></h3>
